...
baseMaps.innerHTML = `<div id='baseMapsid' class='basemapsContainer basemapTray hide'><div style='padding:3px;margin-bottom: 10px;background-color: lightgray;'><p style='margin:0px 0px 5px 0px;font-size:0.8rem;'>Select a base map:</p><div id='basemap1' class='basemaps'><img class='basemapImg' src='./img/google_imagery.png'><div class='basemapLabel'>Google Imagery</div></div><div id='basemap2' class='basemaps'><img class='basemapImg' src='./img/google_terrain.png'><div class='basemapLabel'>Google Terrain</div></div><div id='basemap3' class='basemaps'><img class='basemapImg' src='./img/google_roads.PNG'><div class='basemapLabel'>Google Roads</div></div><br><div id='basemap4' class='basemaps'><img class='basemapImg' src='./img/esri_imagery.PNG'><div class='basemapLabel'>ESRI Imagery</div></div><div id='basemap5' class='basemaps'><img class='basemapImg' src='./img/cartodb_positron.PNG'><div class='basemapLabel'>CartoDB Positron</div></div><div id='basemap6' class='basemaps basemapSelected'><img class='basemapImg' src='./img/stadia_dark.PNG'><div class='basemapLabel'>Stadia Dark</div></div><br><div id='basemap7' class='basemaps'><img class='basemapImg' src='./img/nasa_night.png'><div class='basemapLabel'>NASA GIBS (Night)</div></div><div id='basemap8' class='basemaps'><img class='basemapImg' src='./img/osm_hot.PNG'><div class='basemapLabel'>OSM HOT</div></div><div id='basemap9' class='basemaps'><img class='basemapImg' src='./img/open_topo.PNG'><div class='basemapLabel'>OSM OpenTopo</div></div></div><button id='closeBasemaps' class='baseMapClose'>Close</button></div></div>`;
